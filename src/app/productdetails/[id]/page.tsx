...
import AddWishlistBtn from "@/app/_component/AddWishlistBtn/AddWishlistBtn";
            ...
            <div className="w-full md:w-1/2 px-4">
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600">
                  {data.ratingsAverage} (120 reviews)
                </span>
              </div>
              ...
              <div className="flex space-x-4 mb-6">
                <AddBtn
                  ...
                  cls={
                    "bg-green-600 flex gap-2 items-center text-white px-6 py-2 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                  }
                />
                <AddWishlistBtn
                  cls={`bg-gray-200 flex gap-2 items-center  text-gray-800 px-6 py-2 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2`}
                  child={
                    <>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
